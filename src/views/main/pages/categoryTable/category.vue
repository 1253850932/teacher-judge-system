<template>
    <div class="category">
        <div class="header-box">
            <h2>分类列表</h2>
            <el-input v-model="input" placeholder="请输入内容" @input="searchData(true)"></el-input>
        </div>
        <ul class="list system-scrollbar" ref="listDom" :infinite-scroll-immediate="false" v-infinite-scroll="getCategoryData" style="overflow: auto">
